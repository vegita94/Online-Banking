...
function check(){
 ...
 function isdate()
 {
	var sd=document.getElementsByName("start_date").value;
	var ed=document.getElementsByName("end_date").value;
	   if(sd=="")
	      {
			  return false;
...
<div class="container">
  ...
  <div class="content">
           ...
           <div class="box2">
           <h4 style="float:left; color:blue; margin-top:3px; text-decoration:underline;">Find Transactions</h4>
              <div class="box3">
                      <div class="box4">
                            <div class="box6">
                            ...
                            <div class="box6" style=" background-color:#CCC">
                                ...
                                <h4 style="float:left; color:#666; margin-left:100px;">Account Type</h4>
                                <h4 style="float:left; color:#666; margin-left:100px;">Branch Code</h4>
						 ...
						 for($x=0;$x<$count1;$x++)
                            {	 
						$sql1="select Acc_no,Acc_type,Branch_code from pan_details where User_name='{$_SESSION['pan']['User_name']}' ORDER BY Acc_no LIMIT $x,$count1";
						...
						if(mysql_num_rows($rs1))
						{
							$row1=mysql_fetch_array($rs1);
								...
								?>	
                                <form method="post" action="Show_transaction.php" onSubmit="return check();">
								<table >
                                     <tr>
                                        <td><p style="margin-left:30px;">
                                        
                                        <input type="radio" name="Accno" value="<?php echo $row1['0']; ?>" />
										
										<?php echo $row1['0']; ?> </p></td>
                                        <td><p style="margin-left:150px;"><?php echo $row1['1']; ?></p></td>
                                        <td><p style="margin-left:175px;"><?php echo $row1['2']; ?></p></td>
                                       </tr>
                            </table>
                              <?php
                            } 
                      ...
                      <div class="box5">
                            <div class="box6">
                                  <h4 style=" color:black; float:left">Selected Account No.</h4>
                            </div>
                            <div class="box6" style=" background-color:#CCC">
                                 <h6 style="float:left; color:#03F; size:10px;">Specify the range of dates or amounts for which you wish to view the transaction details</h6>
                            </div>
                            <table  width="100%">
                                 <tr>
                                    <td colspan="2"><p style="text-align:center; text-decoration:underline; margin-bottom:5px;"><b>Data Range</b></p></td> 
                             
                                 </tr>
                            <tr>
                                     <td><p style="text-align:center;"><b>Start Date</b></p></td>
                                     <td><input type="date"  name="start_date"></td> 
                                  <!--     <td><p style="margin-left:200px;"><b>From</b></p></td> 
                                   <td><input type="text" name="From"></td> -->
                                  </tr> 
                                     <tr>
                                     <td><p style="text-align:center;"><b>End Date</b></p></td>
                                     <td><input type="date" name="end_date"></td> 
                              <!--       <td><p style="margin-left:200px;"><b>To</b></p></td> 
                                     <td><input type="text" name="To"></td> -->
                                  </tr>
                                                            
                            </table>
                                <input type="submit" name="view" value="view" onClick="return isdate();" style=" background:#29458F; color:white; font-size:16px; border-radius:5px; margin-left:300px;">
                                <input type="submit" name="Cancel" value="cancel" style=" background:#29458F; color:white; margin-left:2px; font-size:16px;  border-radius:5px;">
                                </form>
