...
<div class="container">
  ...
  <div class="content">
           ...
           <div class="box2">
           <h4 style="float:left; color:blue; margin-top:3px; text-decoration:underline;">Account Summary</h4>
              <div class="box3">
              		<h4 style="color:blue;">Transaction Accounts</h4>
						...
						if(mysql_num_rows($rs1))
						{
							$row1=mysql_fetch_array($rs1);
								...
								?>	
                                <form  method="post" action="Last.php" onSubmit="return check();">
								<table  width="100%">
                                     <tr>
                                        ...
                                        <input type="hidden" name="accno" value="<?php echo $row1['0'];  ?>" />
							...
							?>
                           <p style="float:right;"> <input type="submit"  style="color: #448EA4; margin-top:10px; margin-bottom:10px; font-size:16px; text-decoration:underline; background:white;" value="Click here for last 10 transaction" />  </p>
                            </form>
