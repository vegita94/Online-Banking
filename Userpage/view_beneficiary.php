...
<div class="container">
  ...
  <div class="content">
           ...
           <div class="box2">
           <h4 style="float:left; color:blue; margin-top:3px;"></h4>
              <div class="box3">
             <div class="box6">
						...
						if(mysql_num_rows($rs1))
						{
							$row1=mysql_fetch_array($rs1);
								...
								?>	
                                <form  method="get" action="view_beneficiary2.php" onSubmit="return check();">
								<table  width="100%">
                                     <tr>
                           ...
                           <p style="float:right;"> <input type="submit"  style="color:#448EA4; margin-top:10px; font-size:16px; text-decoration:underline; background:white;" value="Click here to view beneficiary" />  </p>
                            </form>
